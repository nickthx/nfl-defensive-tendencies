...
Last activity: 2026-05-02 — Completed quick task 260502-ftr: Fix header/title spacing on findings/images/01_predictability_ranking.png (renderer fix in render_leaderboard + jupytext sync + PNG regen; commits 1bb2a55, 6872222, 9551dab).
